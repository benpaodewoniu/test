...
class OpenBCIWiFi(object):
    ...
    def __init__(self, ip_address=None, shield_name=None, sample_rate=250, log=True, timeout=10,
                 max_packets_to_skip=20, latency=10000, high_speed=False, ssdp_attempts=5,
